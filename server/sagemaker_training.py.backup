...
class SageMakerTrainingManager:
    ...
    def create_training_job(
        ...
        try:
            ...
            # Try real SageMaker training first, fall back to demo on failure
            try:
                print("🚀 Attempting real SageMaker training job...")
                ...
                for job in response['TrainingJobSummaries']:
                    ...
                    if user_tag and user_tag['Value'] == user_id:
                        user_jobs.append({
                            ...
                            'instance_type': job_details.get('ResourceConfig', {}).get('InstanceType', 'ml.m5.large'),
